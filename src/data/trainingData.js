...
export const trainingData = {
  odp: {
      ...
      topics: [
        {
          title: "What is abuse?",
          description: [
            "Abuse is the deliberate mistreatment of an individual that causes physical, emotional, or psychological harm.",
    ...
    "Individual Rights": {
      ...
      topics: [
        ...
        {
          title: "Right to Be Free from Abuse, Neglect, and Exploitation",
          description: [
  ...
  hab: {
    ...
    "Cultural Competency and Disability Awareness": {
      ...
      objective: [
        "This training builds your ability to respectfully support individuals from diverse cultural backgrounds and with various abilities.",
  ...
  "CPR and First Aid": {
    ...
    "objective": [
      "To Learn how to respond to emergencies and save lives with basic CPR and First Aid skills.",
    ...
    "topics": [
      ...
      },
      {
        ...
        "description": [
          ...
          "Avoid using names in public areas",
  ...
  "Job Duties & Program Expectations": {
  ...
  "Documentation Standards & Progress Notes": {
  ...
  "Incident Management (IM)": {
    ...
    "topics": [
      ...
      },
      {
        ...
        "activity": "Scenario: You notice a person flinches when a staff walks by—what do you do?"
      },
      {
        "title": "Immediate Actions to Take",
        "description": [
      ...
      },
      {
        ...
        "activity": "Scenario: A coworker downplays a serious fall—how do you handle it?"
      },
      {
        "title": "Why Reporting Matters",
        "description": [
      ...
      },
      {
        "title": "Wrap-Up & Reporting Commitment",
        "description": [
          "Know your agency protocol and use your voice to protect others"
        ],
        "activity": "Write a personal reporting commitment statement",
        "conclusion": "Q&A and resource access"
      }
  ...
  "Person-Centered Practices": {
    ...
    "topics": [
      ...
      },
      {
        ...
        "activity": "Scenario: A support plan is created without input from the individual—what's missing?"
      },
      {
        "title": "Key Principles of Person-Centered Practices",
        "description": [
      ...
      },
      {
        ...
        "activity": "Scenario: The individual wants to attend an event you dislike—how do you respond?"
      },
      {
        "title": "Creating Person-Centered Support Plans",
        "description": [
      ...
      },
      {
        ...
        "activity": "How would you support someone who uses a communication board?"
      },
      {
        "title": "Supporting Choice and Decision-Making",
        "description": [
  ...
  "Recognition and Prevention of Exploitation": {    
    "description": "Welcome to Recognition & Prevention of Exploitation Training",
    "objective": [
      "Learn how to identify, respond to, and prevent exploitation of vulnerable individuals."
    ],
    ...
    "topics": [
      {
        ...
        "description": [
          ...
          "Including financial, emotional, sexual, and labor exploitation."
        ],
        "activity": "Match types of abuse to real-life examples."
      },
      {
      ...
      },
      {
        "title": "Your Role as a Mandated Reporter",
        "description": [
          "All ODP staff are mandated reporters under 6100 regulations.",
  ...
  "Positive Approaches and Positive Behaviour Support": {
  ...
  "Provider-Specific Policies and Procedures": {
  ...
  "ODP Regulations and ISP Process": {
...
export const getTrainingData = (type, option) => {
  if (!type || !option) return null;
  return trainingData[type]?.[option] || null;
};